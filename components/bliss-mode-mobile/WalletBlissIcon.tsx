...
import { allBlissModes } from './WalletBlissMode';
import { BlissMode } from '../bliss-mode-core/WalletBlissMode';
import { BlissIcon as BlissIconBase, BlissIconSvg } from '../bliss-mode-core/WalletBlissIcons';

const BlissIcon = ({ icon, blissMode, index }: BlissIconBase) => {
